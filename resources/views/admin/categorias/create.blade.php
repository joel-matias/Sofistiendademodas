        ...
        <form method="POST" action="{{ route('admin.categorias.store') }}" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" name="nombre" value="{{ old('nombre') }}" required
                    class="input @error('nombre') border-red-400 @enderror" placeholder="Ej: Blusas">
                @error('nombre')
            ...
            <div>
                ...
                <textarea name="descripcion" rows="3" class="input resize-none" placeholder="Descripción opcional...">{{ old('descripcion') }}</textarea>
            </div>
