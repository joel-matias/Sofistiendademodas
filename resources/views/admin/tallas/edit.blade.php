...
@section('content')
    <div class="max-w-lg">
        ...
        <form method="POST" action="{{ route('admin.tallas.update', $talla) }}" class="card p-6 space-y-6">
            @csrf @method('PUT')
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="number" name="orden" value="{{ old('orden', $talla->orden) }}"
                            min="0" max="999"
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="pecho" value="{{ old('pecho', $talla->pecho) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="cintura" value="{{ old('cintura', $talla->cintura) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="cadera" value="{{ old('cadera', $talla->cadera) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="largo" value="{{ old('largo', $talla->largo) }}"
