...
@section('content')
        ...
        <div id="hero-carousel" class="relative overflow-hidden bg-tinta min-h-[80vh] sm:min-h-[85vh]">
            ...
            @foreach ($__covers as $i => $cover)
                <div class="hero-slide absolute inset-0 flex items-end transition-opacity duration-700 ease-in-out
                    ...
                    aria-label="{{ $i + 1 }} de {{ count($__covers) }}" data-index="{{ $i }}">
                    ...
                    <div class="relative z-10 w-full px-6 sm:px-10 lg:px-16 pb-16 sm:pb-20">
                        <p class="text-[11px] tracking-[0.3em] uppercase text-moda/80 mb-3 font-medium">Sofis Tienda de
                            Modas</p>
            ...
            @if (count($__covers) > 1)
                ...
                {{-- Dots --}}
                <div class="absolute bottom-5 left-1/2 -translate-x-1/2 z-20 flex gap-2" role="tablist"
                    ...
                    @foreach ($__covers as $i => $cover)
                        <button type="button" onclick="heroCarousel.goTo({{ $i }})"
                            ...
                            role="tab" aria-label="Diapositiva {{ $i + 1 }}"
    ...
    <section class="bg-white border-b border-borde">
        <div class="container-full py-0 grid grid-cols-2 sm:grid-cols-4 sm:divide-x divide-borde text-center">
            @foreach ([['icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', 'text' => 'Calidad garantizada', 'sub' => 'Piezas seleccionadas'], ['icon' => 'M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z', 'text' => 'Atención personal', 'sub' => 'Siempre disponibles'], ['icon' => 'M12 8c-2.21 0-4 1.79-4 4v7h8v-7c0-2.21-1.79-4-4-4zm6 4v7h1a1 1 0 001-1v-5a1 1 0 00-1-1h-1zM6 19v-7H5a1 1 0 00-1 1v5a1 1 0 001 1h1zm8-11a2 2 0 10-4 0v1h4V8z', 'text' => 'Apartados y pedidos', 'sub' => 'Consulta disponibilidad'], ['icon' => 'M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z', 'text' => 'Atención por WhatsApp', 'sub' => 'Resolvemos tus dudas']] as $idx => $p)
                <div
                    class="px-4 py-4 sm:py-5 flex flex-col items-center gap-1
    ...
    <section class="mt-20 sm:mt-24 container-full">
        <div class="relative overflow-hidden rounded-2xl bg-tinta min-h-[260px] sm:min-h-[320px] flex items-center">
            ...
            <div class="relative z-10 px-10 sm:px-16 py-14 w-full sm:w-auto">
                ...
                <p class="mt-3 text-white/50 text-sm max-w-xs hidden sm:block">Descubre las piezas que definen cada
                    temporada.</p>
